...
export function Card ({list , cardsRefArray}) {
    ...
    <div className="screen">
        {list.map((item) => {
            return (
                <div style={{"fontWeight" : "200", "borderColor" : "rgb(118, 118, 118)", "borderWidth" : "1px"}} key={item.number} ref={(element) => cardsRefArray.current.push(element)} className="cards">
                    <div className="numberStyle">{item.number}</div>
